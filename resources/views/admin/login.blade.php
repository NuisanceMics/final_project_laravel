...
<body>
    <div class="login-container text-center">
        ...
        <form action="{{ route('login')}}" method="post">
            @csrf
            <input class="text-center fs-4" type="email" name="email" placeholder="Email" required clear>
            <input class="text-center fs-4" type="password" name="password" placeholder="Password" required clear>
